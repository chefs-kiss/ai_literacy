...
## Looking at Data
1.  For this exercise, you will use the titanic dataset $\href{https://www.kaggle.com/competitions/titanic}{(see:https://www.kaggle.com/competitions/titanic)}$. You may have to sign-in using your Google account to view the data. Use the train.csv dataset on the Data tab to inform your answers below. You can also find the csv [here](../data/titanic_train.csv) 
