...
## Formulas Given
$\text{MAE}: \frac{1}{n}\Sigma |y_{obs} - y_{pred}|$<br>
$\text{MSE}: \frac{1}{n}\Sigma (y_{obs} - y_{pred})^2$<br>
$\text{RMSE}: \sqrt{\text{MSE}}$<br>
$y_{pred}=\beta_1 x_1+\beta_0$<br><br>
$\nabla C(x,y) = (\frac{\delta C}{\delta y}(x,y), \frac{\delta C}{\delta x}(x,y)$<br>
